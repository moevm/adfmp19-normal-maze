...
class StartMenu : MainMenuAbstract() {
    ...
    private val game: DefaultTextButton = DefaultTextButton(0.5f, 0.70f, 0.4f, 0.1f, "Game") { UiUtils.menuPainter?.chooseGame() }
    private val rules: DefaultTextButton = DefaultTextButton(0.5f, 0.5f, 0.4f, 0.1f, "Rules") { UiUtils.menuPainter?.rules() }
    private val statistic: DefaultTextButton = DefaultTextButton(0.5f, 0.3f, 0.4f, 0.1f, "Statistic") { UiUtils.menuPainter?.statistic() }
