...
class PopUpPause : PopUpMenu() {
    ...
    init {
        ...
        back = DefaultTextButton(0.5f, 0.7f, 0.2f, 0.1f, "back") { UiUtils.menuPainter?.closePopup() }
        rule = DefaultTextButton(0.5f, 0.55f, 0.2f, 0.1f, "rule") { UiUtils.menuPainter?.goToRule() }
        statistics = DefaultTextButton(0.5f, 0.4f, 0.2f, 0.1f, "statistics") { UiUtils.menuPainter?.goToStatistic() }
        exitToMainMenu = DefaultTextButton(0.5f, 0.25f, 0.2f, 0.1f, "Exit to Main Menu") { UiUtils.menuPainter?.exitToMainMenu() }
    }
